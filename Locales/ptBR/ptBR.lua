...
--[[GM tab]]
  ...
  --["tt_chatoffbutton"]              = "Turn GM Chat OFF",
    ...
    ["tt_acctdeletebutton"]           = "Exclui uma conta de jogador e todos os personagens [[Parâmetros: $accountname]]",
...
--[[Char Tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_HonorUpdateButton"]          = "Nenhum parâmetro necessário. Salva Honra para o jogador **selecionado**.",
  --[[Control Labels]]
    ["ma_KillButton"]                 = "Matar",
...
--[[Misc Tab]]
  ...
  --[[Control Labels]]
    ...
    ["ma_UpdateFrequencyLabel"]       = "Especifica a frequência de atualização do gráfico Diff na aba Servidor.\n10000 = ~1 minuto, 50000 = ~5 minutos",
