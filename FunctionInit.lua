...
--[[GM Tab]]
  ...
  MangAdmin:PrepareScript(ma_cheattaxionbutton               , Locale["tt_TaxiOnButton"]               , function() ToggleCheatTaxi("on") end)
  MangAdmin:PrepareScript(ma_cheattaxioffbutton              , Locale["tt_TaxiOffButton"]              , function() ToggleCheatTaxi("off") end)
...
--[[Misc Tab]]
  ...
  MangAdmin:PrepareScript(ma_updatechangesbutton             , Locale["tt_updatechanges"]              , function() ApplyStyleChanges() end)
