...
--[[GM tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_HoverOnButton"]              = "공중 부양 모드를 활성화합니다.",
    ["tt_HoverOffButton"]             = "공중 부양 모드를 비활성화합니다.",
    ...
    ["tt_ShowMapsButton"]             = "선택한 캐릭터의 지도를 공개합니다.",
    ["tt_HideMapsButton"]             = "선택한 캐릭터의 지도를 숨깁니다.",
  ...
  --["tt_chatoffbutton"]              = "GM 채팅 끄기",
    ...
    ["tt_accountlockonbutton"]        = "계정을 잠급니다",
    ["tt_accountlockoffbutton"]       = "계정 잠금을 해제합니다",
  ...
  --[[Control Labels]]
    ...
    ["ma_HoverOnButton"]              = "공중 부양 모드 켜기",
    ["ma_WhisperOnButton"]            = "귓속말 켜기",
    ["ma_InvisOnButton"]              = "투명 켜기",
    ["ma_TaxiOnButton"]               = "택시 치트 켜기",
    ["ma_ShowMapsButton"]             = "지도 표시",
    ["ma_HideMapsButton"]             = "지도 숨기기",
    ...
    ["ma_mapsbutton"]                 = "모든 지도 보기",
    ["ma_waterwalkbutton"]            = "물 위 걷기 켜기",
    ["ma_accountlockbutton"]          = "계정 잠금",
    ["ma_gmnotify"]                   = "GM 알림",
    ["ma_gmingame"]                   = "게임 내 GM",
    ["ma_gmlist"]                     = "GM 목록",
    ["ma_petcreate"]                  = "펫 생성",
...
--[[Char Tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_QuestAddButton"]             = "**선택한** 플레이어에게 #questid를 추가합니다.",
    ["tt_QuestCompleteButton"]        = "**선택한** 플레이어의 #questid를 완료로 표시합니다.",
    ["tt_QuestRemoveButton"]          = "**선택한** 플레이어로부터 #questid를 제거합니다.",
    ...
    ["tt_HonorAddButton"]             = "**선택한** 플레이어에게 #honorpoints를 추가합니다.",
    ["tt_HonorUpdateButton"]          = "매개변수 필요 없음. **선택한** 플레이어의 명예를 저장합니다.",
  --[[Control Labels]]
    ["ma_KillButton"]                 = "죽이기",
    ["ma_ReviveButton"]               = "부활",
    ["ma_SaveButton"]                 = "저장",
    ...
    ["ma_ShowMapsCharButton"]         = "지도 표시",
    ["ma_HideMapsCharButton"]         = "지도 숨기기",
    ...
    ["ma_HonorAddButton"]             = "명예 추가",
    ["ma_HonorUpdateButton"]          = "명예 업데이트",
    ["ma_CharRotateLeft"]             = "<<=",
    ["ma_CharRotateRight"]            = "=>>",
    ["ma_CharZoomIn"]                 = "+",
    ["ma_CharZoomOut"]                = "-",
